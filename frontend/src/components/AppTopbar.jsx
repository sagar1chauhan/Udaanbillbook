    ...
    <>
      <header className="sticky top-0 z-30 flex h-16 items-center gap-2 border-b bg-card/80 px-3 backdrop-blur md:px-6">
        <button 
          ...
          className="md:hidden flex items-center justify-center p-1 rounded-xl hover:bg-secondary transition-colors shrink-0"
        >
          <img src={logo} alt="Udaan" className="h-9 w-9 rounded-xl object-cover shadow-sm" />
        </button>
        <SidebarTrigger className="hidden md:inline-flex -ml-1" />
